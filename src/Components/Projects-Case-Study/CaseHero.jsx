...
const Hero = () => {
  return (
    <>
      <div className="hero-container p-2 flex flex-col gap-6 justify-start items-start mx-auto space-x-auto">
        ...
        <section className="second-hero-section flex flex-col gap-3 justify-center items-start  p-2">
          <h4 className=" font-dm text-white font-normal text-xl text-left pb-6">
