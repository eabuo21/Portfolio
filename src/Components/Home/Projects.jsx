          ...
          <div className="second-wrapper md:relative md:left-[2rem]  md:pb-16   md:flex-col  ">
            ...
            <div className="buttons-section flex flex-row gap-3 pb-6 justify-start items-start p-2  text-white text-base  md:gap-3  md:pb-6">
              <Link to="https://tongston.com" target="_blank">
                <button
                  className="p-3 w-[fixed] flex justify-center items-center  bg-gradient-to-r from-[red] to-[#6f0b6f] rounded-[12px] 
              ...
              <Link to="https://tongston.netlify.app" target="blank">
                ...
                border-l-red rounded-[12px] hover:border-t-blue-400  hover:border-l-blue-400  hover:border-b-blue-700 hover:border-r-blue-700"
                >
                  View Demo
                </button>
              </Link>
          ...
          <div className="second-wrapper md:relative md:left-[2rem]     md:ml-[15rem] ">
            ...
            <div className="buttons-section flex flex-row gap-1 justify-start items-start p-2  text-white text-base gap-3 pb-6   md:gap-3  md:pb-6 ">
              ...
              <Link to="https://tongston-ventures.netlify.app" target="blank">
                ...
                border-b-[#a122a1] border-l-red rounded-[12px]
